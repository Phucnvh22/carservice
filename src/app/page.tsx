          ...
          <div className="space-y-8">
            ...
            <ScrollReveal direction="up" delay={100}>
              <h1 className="text-4xl font-extrabold leading-[1.1] tracking-tighter text-porsche-black text-balance md:text-6xl lg:text-[4rem]">
                Đặt xe từ sân bay Huế,{" "}
                <span className="text-porsche-red">City tour</span> & thuê xe tự
                lái
              </h1>
            </ScrollReveal>
            ...
            <ScrollReveal direction="up" delay={200}>
              <p className="max-w-xl text-lg leading-relaxed text-porsche-grey-80 md:text-xl">
                Dịch vụ xe Huế cho khách du lịch và công tác: đưa đón sân bay
                Phú Bài, tour trong ngày, thuê xe tự lái/xe có tài xế. Nhắn
                Zalo hoặc gọi{" "}
                <a
            ...
            <ScrollReveal direction="up" delay={0}>
              <div className="max-w-2xl">
                ...
                <p className="mt-4 text-lg text-porsche-grey-80">
                  Mỗi mục điều hướng dẫn tới một màn hình riêng, nội dung rõ
                  ràng và chi tiết.
                </p>
              </div>
            </ScrollReveal>
              ...
              >
                ...
                >
                  ...
                  <div className="mt-8 flex items-center text-xs font-bold uppercase tracking-widest text-porsche-black">
                    <span className="relative after:absolute after:bottom-0 after:left-0 after:h-px after:w-0 after:bg-porsche-black after:transition-all after:duration-300 group-hover:after:w-full">
                      Mở màn hình
                    </span>
                    <svg
          ...
          <div className="mx-auto grid max-w-4xl gap-4">
            {faqs.map((f, idx) => (
              <ScrollReveal
                ...
                delay={idx * 100}
              >
                <details className="group rounded-none border border-porsche-grey-20 bg-porsche-white p-6 transition-all duration-300 open:border-porsche-black open:shadow-lg hover:border-porsche-grey-40">
            ...
            <ScrollReveal direction="left" delay={0}>
              <div>
                ...
                <p className="mt-4 text-lg text-porsche-grey-40 max-w-md">
                  Gửi thông tin chuyến đi hoặc gọi hotline để chốt xe nhanh.
                  Đội ngũ chúng tôi hỗ trợ 24/7.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal direction="right" delay={200}>
