    ...
    <div className="mx-auto max-w-6xl px-4 py-10 md:py-20">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {pricingData.map((plan, idx) => (
          <div key={idx} className="relative flex flex-col rounded-3xl border border-slate-200 bg-white p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl hover:border-porsche-red group">
            {idx === 2 && (
